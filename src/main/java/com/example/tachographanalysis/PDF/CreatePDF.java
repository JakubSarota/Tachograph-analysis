...
public class CreatePDF {
    public static String createPDF(String[] date, String fileName, String nameOfImage, BarChart... barCharts) throws IOException, DocumentException, ParserConfigurationException, SAXException {
...
//        System.out.println("Stop");
    ...
    public static String createPDF2(String[] date, String fileName, String nameOfImage, AreaChart... barCharts) throws IOException, DocumentException, ParserConfigurationException, SAXException {
//        System.out.println("Start");
        Document doc = new Document();
        PdfWriter writer;
        File dir = new File(".\\PDF\\");
